...
public class CipherText {
    //g1
    private Element c_wave;  //C~ = M * e(g,g)^(Alpha*s)
    //g0
    private Element c;  //C = h^s 【= g^(Beta*s)】
    //g0
    private Map<Attribute,Element> c_y_map;  //Cy = g^qy(0)
    //g0
    private Map<Attribute,Element> c_y_pie_map;  //Cy' = [H(att(y))]^qy(0)
    //访问树
