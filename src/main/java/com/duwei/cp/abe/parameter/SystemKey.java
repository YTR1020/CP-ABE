...
public class SystemKey {
    ...
    public static SystemKey build() {
        ...
        MasterPrivateKey masterPrivateKey = MasterPrivateKey.build(pairingParameter);  //创建系统密钥
        PublicKey publicKey = PublicKey.build(pairingParameter, masterPrivateKey);  //创建系统公钥
